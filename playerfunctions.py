...
def equip(character, item, slot):
    ...
    character.leftHand, character.rightHand, character.head, character.body, character.legs, character.belt, character.boots, character.gloves, character.back = (x for x in character.gear)
    character.update()       
...
def unequip(character, item, slot):
    ...
    if slot in resources.slots:
        if character.gear[resources.slots.index(slot)] != None:
            character.inventory.append(character.gear[resources.slots.index(slot)])
