...
skills =     ['acting',
    'anthropology', 'xenoanthropology',
    'diplomacy',
    'medicine', 'vehicles', 'technology', 'xenotechnology',
    'sleightofhand', 'stealth',
    'insight', 'perception', 'survival', 'tactics',
    'athletics', 'acrobatics']
slots = ['leftHand', 'rightHand', 'head', 'body', 'legs', 'belt', 'boots', 'gloves', 'back']

# generic NPCs
# TODO: equip NPCs

airman = character.Character('airman', hitdie=10, hp=10, dexterity=12, constitution=12,
anthropology=1, technology=1, sleightofhand=1, stealth=1, perception=2, tactics=3, athletics=3, acrobatics=3)

jaffa = character.Character('jaffa', race='jaffa', clas='guardian', hitdie=10, hp=10, strength=12, dexterity=12, constitution=12, charisma=8,
xenoanthropology=1, xenotechnology=1, stealth=1, perception=1, survival=2, tactics=1, athletics=2, acrobatics=1)

asgard = character.Character('asgard', race='asgard', hitdie=6, hp=6, speed=20, strength=4, dexterity=8, constitution=6, intelligence=16, wisdom=14, charisma=8,
anthropology=3, xenoanthropology=4, diplomacy=2, medicine=3, vehicles=1, technology=3, xenotechnology=4, insight=1)

goauld = character.Character('goauld', race='goauld', clas='system lord', hitdie=12, hp=12,
strength=14, dexterity=14, constitution=16, intelligence=14, wisdom=10, charisma=14,
acting=1, anthropology=1, xenoanthropology=4, medicine=4, vehicles=2, technology=2, xenotechnology=3, sleightofhand=1, stealth=1, insight=1, perception=2,
survival=1, tactics=1, athletics=2, acrobatics=2)
...
p90 = item.Weapon('FN P90', '5.7x28mm FMJ', weight=3.0, range=200, damage=12, proficiency='dexterity', cqcpenalty=1)
m24 = item.Weapon('M24', '7.62x51mm', weight=7.0, range=800, damage=20, proficiency='dexterity', cqcpenalty=3)
zat = item.Weapon("Zat'nik'tel", weight=1.0, range=75, damage=0, proficiency='dexterity', cqcpenalty=1)
matok = item.Weapon("Ma'tok", weight=5.0, range=50, damage=30, proficiency='strength', cqcpenalty=0)
...
scanner = item.Item('Alteran Scanner', 
