...
class Template(character.Character):
    def __init__(self, name=None, race=None, class_=None, slots=None):
        ...
        # with open(cfg.paths.RACES_PATH + self.race + sep + self.race + ".json", encoding='utf-8') as f:
    ...
    def load_slots(self):
        ...
        with open(cfg.paths.RACES_PATH + self.race + sep + "defaults.json", encoding='utf-8') as f:
    ...
    def save(self):
        with open(cfg.paths.RACES_PATH + self.race + sep + templates + sep + self.name + ".json", 'w+', encoding='utf-8') as f:
